...
#### 经过一系列代码压缩尝试，发现自身能力下无法进一步压缩，灵感也枯竭，最终先进行打包测试，先确定可参赛的版本，同时在剩余比赛时间思考其他玩法和设计的可行性，

以下为打包前的源码，约70k字节，且直接zip打包就以达到13k的参赛要求
...
​		**在我能力范围内我完成了这部作品，里面可能有一些别的游戏的影子，技术上更谈不上有什么创新，甚至没有经过代码压缩，甚至没有删除注释，但是我并不是没有过尝试，在经过一系列代码压缩的操作后，不知为何我获得了和我最终打包版本没有什么区别的压缩包，13k的限制可能需要顶级开发者才能物尽其用**
